...
typedef enum {type_Program, type_FieldDecl,  type_VarDecl, type_MethodDecl, type_MethodHeader, type_MethodParams, type_ParamDecl,
              ...
              type_ParseArgs, type_Or, type_And, type_Eq, Neq, type_Lt, type_Gt, type_Leq, type_Geq, type_Add, type_Sub, type_Mul, type_Div, type_Mod, type_Not, type_Minus,
              type_Plus, type_Length, type_Bool, type_BoolLit, type_Double, type_DecLit, type_Id, type_Int, type_RealLit, type_StrLit, type_Void } NodeType;
